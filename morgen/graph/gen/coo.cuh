...
#include <morgen/graph/coo_graph.cuh>
...
{ 
    ...
    csr_graph.fromCoo(coo, ll_nodes, ll_edges);
...
int cooGraphGen(
    FILE* fp,
    CooGraph<VertexId, SizeT, Value> &coo_graph)
{ 
    typedef CooEdgeTuple<VertexId> EdgeTupleT;
    ...
    coo_graph.fromCoo(coo, ll_nodes, ll_edges);
